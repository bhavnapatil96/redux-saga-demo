...
let like = require('./models/likes').like;
...
app.post('/api/like/add', (req, res) => {
    like.findOne({userId:req.body.userId,eventId:req.body.eventId}).then((success)=>{
        if(success)
        {
            console.log('success',success)
            like.findByIdAndRemove({_id:success._id}).then((data)=>{


                event.findById(req.body.eventId).then((data) => {
...
app.post('/api/event/likeupdate', (req, res) => {
